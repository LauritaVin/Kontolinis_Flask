...
def register():
    if current_user.is_authenticated:
        return redirect(url_for('index')) #Jei vartotojas jau egzistuoja, grazina i home page
...
def all_entries():
    ...
    for entry in all_entries:
        entry.type_label = "Income" if entry.income else "Expense"
...
def account():    
    ...
    if request.method == 'GET':  #automatiskai uzpildo eilutes, nes kitaip NULL error gaunasi
